...
from commons import DATA_PATH, DEFAULT_RANDOM_STATE, FEATURE_COLUMNS, TARGET_COLUMN
...
# -------------------------------
def poison_dataset(X, y, poison_percent, random_state=DEFAULT_RANDOM_STATE):
    ...
    poisoned_df[TARGET_COLUMN] = y_poison
